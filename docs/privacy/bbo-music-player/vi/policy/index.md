---
title: Thông báo chuyển dữ liệu xuyên biên giới | LyriFloat
...
Ứng dụng (“**LyriFloat**”) sử dụng **Google AdMob** để phân phối và đo lường quảng cáo trong ứng dụng. Trong quá trình này, dữ liệu cá nhân có thể được **chuyển ra ngoài** quốc gia của bạn.
