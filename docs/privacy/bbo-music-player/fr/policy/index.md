---
title: Avis relatif au transfert transfrontalier de données | LyriFloat
...
Cette app (« **LyriFloat** ») utilise **Google AdMob** pour fournir et mesurer la publicité in-app. Dans le cadre de ces services, des données personnelles peuvent être transférées hors de votre pays.
