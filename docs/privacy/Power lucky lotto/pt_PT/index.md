...
description: Política de Privacidade do Power lucky lotto (Português - Portugal)
lang: pt-pt
...
Em algumas regiões (por exemplo, EEA/UK/CH), pode ser apresentado um formulário de consentimento UMP e pode existir uma entrada **Opções de Privacidade (Privacy Options)** quando exigido.
...
- **Ajustar opções de anúncios/consentimento:** via Opções de Privacidade na app (quando disponível) ou definições de anúncios do SO (repor ID de publicidade, limitar personalização).  
