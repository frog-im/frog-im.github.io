...
Esta aplicação (“**TimeBack*”) utiliza o **Google AdMob** para disponibilizar e medir publicidade na aplicação. No âmbito da prestação destes serviços, dados pessoais podem ser transferidos para fora do seu país.
